...
export default function ChartSection({ t, sessions, totalAll, dailyGoalMinutes, tasks = [] }) {
  ...
  return (
    <div>
      ...
      <div style={{ fontSize: 10.5, color: t.sub, marginBottom: 14 }}>
        Change your daily target in the <strong>Goal</strong> tab in Progress, or in Settings.
      </div>
